...
<!-- IMAGE 01 — TA MINIATURE / CENTRÉE -->

<div className="gallery-item">
  <img
    src="/images/yanineko-aspiration-miniature.png"
    alt="YaniNeko — Dernière cigarette / Aspiration"
  />
</div>

> *et finalement, me voilà à en faire un petit fanmade.*

Il y a parfois des œuvres sur lesquelles on tombe un peu par hasard, sans forcément
...
Le terme me vient surtout de ma propre digression  
et parce que le manga donne davantage cette impression,  
alors que l'anime, finalement, ressemble presque à un anime assez normal.

Il y a ses personnages, son humour, ses situations, son quotidien...

Rien qui hurle immédiatement au « mini-ovni ».  
Et pourtant, il y a régulièrement ces petites bifurcations,  
ces conversations ou ces détails qui donnent l'impression que l'œuvre peut partir ailleurs pendant quelques instants.

C'est peut-être justement ce qui me plaît.

Elle n'a pas besoin d'être complètement bizarre ou expérimentale pour me faire
sortir un peu du chemin prévu.

<!-- IMAGE 02 — VISUEL À DROITE -->

<div className="image-right">
  <img
    src="/images/yanineko-visuel-01.png"
    alt="Plusieurs exemples des personnages de YaniNeko"
  />
</div>
...
Mais on peut aussi commencer à regarder ce qui se passe autour d'eux, leurs habitudes, leurs petits travers, leurs relations...
...
<details className="article-details">
  <summary><strong>Les personnages — Liste déroulante détaillée pour les plus curieux/curieuses ~*</strong></summary>
  ...
  <div className="character-card">
    <img
      src="/images/yanineko-character-yaniko.png"
      alt="YaniNeko / Yaniko"
    />
    <div>
      <h3>YaniNeko / Yaniko</h3>
      <p>
        Le personnage central, et forcément mon point d'entrée dans l'œuvre.
        Son vrai nom est Satō Yaniko. Elle a 21 ans et le tabac occupe une place
        assez centrale dans son quotidien.

        Mais ce qui m'intéresse finalement davantage est tout ce qui se construit
  ...
  <div className="character-card">
    <img
      src="/images/yanineko-character-imoko.png"
      alt="Imoko"
    />
    <div>
      <h3>Imoko</h3>
      <p>
        La petite sœur de YaniNeko. À l'inverse de sa sœur, Imoko est présentée
        comme une lycéenne sérieuse, responsable et plutôt bonne élève.

        Elle est assez dure avec YaniNeko, mais c'est aussi clairement lié à
        l'affection qu'elle lui porte et à son côté protecteur.
  ...
  <div className="character-card">
    <img
      src="/images/yanineko-character-yakineko.png"
      alt="YakuNeko"
    />
    <div>
      <h3>YakuNeko</h3>
      <p>
        YakuNeko a 20 ans et considère YaniNeko comme sa « senpai ».

        Il est présenté comme un bon junior, même si son passé semble cacher
        certaines choses qu'il ne raconte pas forcément.
  ...
  <div className="character-card">
    <img
      src="/images/yanineko-character-hameneko.png"
      alt="HameNeko"
    />
    <div>
      <h3>HameNeko</h3>
      <p>
        Une gameuse/streameuse de jeux de combat apparemment, qui fait également
        des vidéos sur sa propre chaîne.

        Elle était au lycée avec YakuNeko et possède évidemment son propre petit
        univers au milieu de cette galerie de personnages.

        La petite touche étant son... Flot ? ahah ^^'

        Et mine de rien, comme les autres personnages que l'on accepte
  ...
  <div className="character-card">
    <img
      src="/images/yanineko-character-kansaineko.png"
      alt="KansaiNeko"
    />
    <div>
      <h3>KansaiNeko</h3>
      <p>
        Une étudiante qui parle avec son accent du Kansai
        (là par contre, je n'ai pas le recul en tant qu'occidental pur jus ^^').

        Elle peut paraître très élégante et même assez jolie au premier regard,
        mais elle possède surtout une vraie envie de faire rire les autres,
        avec un résultat qui n'est pas toujours à la hauteur de ses ambitions.

        Mais j'en comprends les rouages, car c'est souvent un archétype représenté.
      </p>
    </div>
  </div>
  ...
  <div className="character-card">
    <img
      src="/images/yanineko-character-aruneko.png"
      alt="AlNeko"
    />
    <div>
      <h3>AlNeko</h3>
      <p>
        AlNeko a 24 ans et est étudiante à l'université.

        Son apparence peut facilement tromper au premier regard, mais elle est bien
        adulte et possède notamment un rapport très marqué à l'alcool.
      </p>
    </div>
  </div>
  ...
  <div className="character-card">
    <img
      src="/images/yanineko-character-tatsuro.png"
      alt="Ochinpo Tatsuro"
    />
    <div>
      <h3>Ochinpo Tatsuro</h3>
      <p>
        De son vrai nom Saori Tatsuno, c'est une mangaka professionnelle de
        32 ans qui vit dans le même immeuble que YaniNeko.
  ...
  <div className="character-card">
    <img
      src="/images/yanineko-character-ooya.png"
      alt="Le propriétaire de l'immeuble"
    />
    <div>
      <h3>Le propriétaire</h3>
      <p>
        Le propriétaire de l'immeuble où vivent plusieurs de ces personnages.

        Il peut sembler assez impressionnant au premier abord, mais le site
        officiel le présente surtout comme quelqu'un de raisonnable et attentionné,
        ce qui est plutôt utile au milieu de tout ce petit monde.

        Ceci dit, gros bémol : il a aussi ses addictions et ses torts, et je ne
        saurais pas vraiment aller plus loin là-dessus puisque je n'ai pas lu
        entièrement l'œuvre.

        Il a peut-être lui aussi un autre visage à découvrir, mine de rien.
      </p>
    </div>
  </div>
  ...
  <p>
    ...
    Finalement, chacun apporte sa propre petite bizarrerie à l'ensemble.
  </p>
...
Les petits travers des personnages.

Et finalement cette façon qu'ont les gens de se construire autour de choses parfois
complètement banales.

Je ne veux évidemment pas présenter le tabagisme comme quelque chose à promouvoir.  
Ce n'est pas vraiment ce que j'y ai vu.
...
Les autres personnages ont eux aussi leurs propres habitudes,  
leurs excès ou leurs petites obsessions.
...
<div className="image-center">
  <img
    src="/images/yanineko-visuel-02.png"
    alt="Personnages de YaniNeko"
  />
</div>
...
C'est déjà une trajectoire assez particulière.
...
Sa première réaction semble avoir été assez proche de :

> *« Est-ce vraiment possible ? »*

Puis, en découvrant les scripts et les character designs, cette inquiétude initiale
semble avoir laissé place à quelque chose de beaucoup plus positif.

L'auteur explique notamment avoir eu le sentiment que l'équipe pouvait réellement
faire l'œuvre « telle quelle », et souligne la qualité du travail déjà réalisé,
notamment l'animation ainsi que les musiques d'ouverture et de fin.

Et ça, je trouve ça plutôt chouette.  
Parce que c'est justement l'impression que j'avais eue.

<!-- IMAGE 05 — GRAND VISUEL OFFICIEL -->

<div className="image-center">
  <img
    src="/images/yanineko-anime-01.png"
    alt="YaniNeko — adaptation animée"
  />
</div>

Je ne vais évidemment pas prétendre que cela signifie que le studio a
« officiellement reconnu tout le potentiel » du manga ou autre grande formule du genre.

Mais quand l'auteur lui-même explique avoir été agréablement surpris par ce que
l'équipe lui présentait, ça donne quand même un peu de poids à cette impression.

Et puis, visuellement, je trouve que ça se sent.
...
Je ne vais pas faire semblant d'être spécialiste de l'animation japonaise  
et encore moins décortiquer chaque choix technique.

Ce qui m'intéresse davantage, c'est le résultat.
...
Tout cela donne finalement davantage de vie aux personnages.

<!-- IMAGE 06 — À GAUCHE -->

<div className="image-left">
  <img
    src="/images/yanineko-anime-02.png"
    alt="YaniNeko — adaptation animée"
  />
</div>
...
<!-- IMAGE 07 — TA PROPRE CAPTURE / MINIATURE FINALE -->

<div className="image-center">
  <img
    src="/images/yanineko-aspiration-final.png"
    alt="Fanmade YaniNeko — Dernière cigarette"
  />
</div>
...
Et finalement, ça me semble assez cohérent avec la manière dont j'ai découvert l'œuvre.
...
**Informations officielles sur l'anime et son lancement**

**Key visual / personnages**

### L'auteur et l'adaptation

**Nyan Nyan Factory — retour sur l'adaptation**

C'est probablement la source que je trouve la plus intéressante pour comprendre
comment l'auteur a vécu l'arrivée de l'adaptation animée.

### Personnages et interviews

Le site officiel regroupe également les fiches des personnages ainsi que les
différentes interviews des membres du casting et de l'équipe.

### Ressources mises à disposition

Le site officiel propose également certains visuels explicitement mis à disposition
du public, notamment un poster créé par Nyan Nyan Factory et proposé gratuitement
au téléchargement pour un usage personnel.

---

## Quelques sources et précisions

Les informations concernant l'adaptation,  
l'équipe de production et les déclarations de Nyan Nyan Factory proviennent du site officiel de l'anime.

Je préfère préciser ce point parce qu'entre les fiches de sites spécialisés,  
les réseaux sociaux, les vidéos de réaction et les informations parfois recopiées d'un site à l'autre,  
il devient vite difficile de savoir ce qui vient réellement de l'équipe.

Ici, autant remonter directement à la source lorsque c'est possible.

---

> *Une œuvre n'a peut-être pas besoin d'être exceptionnelle pour donner envie de
> tirer un fil.*
>
